...
#
# Version 8.13: 2020-11-16 ready-for.sh
#   - Add LFS143
# 
#===============================================================================
VERSION=8.13
...
#-------------------------------------------------------------------------------
PACKAGES[LinuxMint]=
PACKAGES[LinuxMint-19.2]=
PACKAGES[LinuxMint-19.3]=
PACKAGES[LinuxMint-20]=
#-------------------------------------------------------------------------------
PACKAGES[openSUSE]=
...
FALLBACK=(
    ...
    [LinuxMint]="Ubuntu"
    [LinuxMint-19]="Ubuntu-18.04 Ubuntu"
    [LinuxMint-19.2]="LinuxMint-19 Ubuntu-18.04 Ubuntu"
    [LinuxMint-19.3]="LinuxMint-19.2 Ubuntu-18.04 Ubuntu"
    [LinuxMint-20]="LinuxMint-19.3 Ubuntu-20.04 Ubuntu"
    ...
    [Ubuntu-20.10]="Ubuntu-20.04 Ubuntu-18.04 Ubuntu Debian-10"
...
DISK=5
#DISTROS=
DISTROS[EMBEDDED]="CentOS-8+ Debian-10+ Fedora-32+ LinuxMint-20+ openSUSE-15+ Ubuntu-18.04+LTS+"
DISTROS[LFD]="CentOS-8+ Debian-10+ Fedora-32+ LinuxMint-19+ openSUSE-15+ RHEL-8+ Ubuntu-18.04+LTS+ SLES-15+"
DISTROS[LFS]="CentOS-7+ Debian-9+ Fedora-31+ LinuxMint-19+ openSUSE-15+ RHEL-7+ Ubuntu-18.04+LTS+ SLES-15+"
DISTRO_ARCH=x86_64
DISTRO_BL="CentOS-6- Debian-8- Fedora-30- LinuxMint-18.3- openSUSE-42.3- OracleLinux RHEL-6- SLES-12.2- Ubuntu-19.10-"
...
SUGGESTS[Ubuntu-16.04_@common]="[Debian-9_@common]"
#-------------------------------------------------------------------------------
...
PACKAGES[Ubuntu-16.04_@ebpf]="-bpfcc-tools"
...
PACKAGES[RHEL-6_@trace]="-kernelshark"
...
RAM[LFD272]=2
DISTROS[LFD272]="Ubuntu-16.04+LTS+"
...
PACKAGES[Ubuntu-16.04_LFD450]="libpython-dev libtool-bin"
...
#-------------------------------------------------------------------------------
OS[LFS143]="$ANYOS"
OS_NEEDS[LFS132]="docker, docker-engine, kubectl, kind/k3s"
#-------------------------------------------------------------------------------
CPUS[LFS143]=2
...
PACKAGES[Ubuntu-16.04_LFS153]="-default-mysql-server mysql-server"
PACKAGES[Fedora_LFS153]="community-mysql-server"
PACKAGES[CentOS_LFS153]="mysql-server"
PACKAGES[CentOS-7_LFS153]="-mysql-server"
PACKAGES[openSUSE_LFS153]="-golang -nodejs nodejs12 -php"
PACKAGES[openSUSE-15.1_LFS153]="-nodejs12"
...
WEBPAGE[LFS265]="$LFSTRAINING/software-defined-networking-essentials"
INPERSON[LFS265]=n
VIRTUAL[LFS265]=n
SELFPACED[LFS265]=y
...
PACKAGES[Debian-11_LFS265]="[Debian-10_LFS265] -mininet -python-openvswitch"
...
DISTROS[LFS422]="CentOS:amd64-7+ Debian-9+ Ubuntu:amd64-16.04+LTS+"
...
PACKAGES[RHEL_LFS426]="numactl-libs"
PACKAGES[RHEL-6_LFS426]="cpufrequtils -numactl-libs"
